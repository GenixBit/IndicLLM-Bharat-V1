...
class LocalInferenceConfig:
    ...
    def __post_init__(self) -> None:
        object.__setattr__(
            self,
            "checkpoint_path",
            _local_path(self.checkpoint_path, field_name="checkpoint"),
        )
        object.__setattr__(
            self,
            "tokenizer_path",
            _local_path(self.tokenizer_path, field_name="tokenizer"),
        )
...
class LocalCausalLMAdapter:
    ...
    generator: TokenGenerator = field(default=_generate_with_bharat_model)
    ...
    def predict(self, example: EvalExample) -> str:
        ...
        if generated.dim() != 2 or generated.shape[0] != 1:
            raise ValueError("Generated IDs must have shape (1, sequence)")
